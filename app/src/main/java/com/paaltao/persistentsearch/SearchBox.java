package com.paaltao.persistentsearch;
...
import com.paaltao.materialmenu.MaterialMenuDrawable.IconState;
import com.paaltao.materialmenu.MaterialMenuView;

import java.util.ArrayList;
import java.util.List;

import com.paaltao.codetail.animation.ReverseInterpolator;
import com.paaltao.codetail.animation.SupportAnimator;
import com.paaltao.codetail.animation.ViewAnimationUtils;
...
public class SearchBox extends RelativeLayout {
    ...
    /**
     * Populates the searchbox with the most relevant match. Used by the voice input
     *
     * @param matches Matches
     * @see {@link android.speech.RecognizerIntent#EXTRA_RESULTS}
     */
